...
# Desafio 04: importar o módulo requests - Ele obtem o código da página
...
# Aula 128: Lista (vetor) para salvarmos todos os novos detalhes dos planetas
new_planets_data = []

# Aula 128 - Função para extrair dados dos hiperlinks
def scrape_more_data(hyperlink):
    try:
        # Desafio 05: Crie uma variável chamada page e obtenha o conteúdo do hiperlink usando o método get() do módulo requests
        

        # Desafio 06: Crie um objeto BeautifulSoup chamado soup para obter o código HTML usando page.content do módulo requests e html.parser
        

        #Desafio 07: Crie uma lista vazia chamada temp1_list para armazenar os dados temporariamente
    ...
    # Aula 128: Bloco except trata a exceção para iterar e ir para o próximo link
    except:
        time.sleep(1)
        scrape_more_data(hyperlink)

csv_file_path = r'C:\aula127_teste\updated_scraped_data.csv'
# Desafio 08: Crie o planet_df_1 para armazenar o arquivo CSV atualizado da forma de um dataframe
planet_df_1 = pd.read_csv(csv_file_path)

# Aula 128 - Loop para obter os dados do hiperlink. Método iterrows do pandas, para percorrer as linhas do dataframe e obter o hiperlink
...
# Desafio 09: Crie uma nova lista scrapped_data, pois vamos manipula-lá para extração do '\n' (quebra de linha)


# Aula 128 - Manipulação para remover o caracter de cada link
